...
public abstract class RSACoder {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// byte[]
			// encodedData1=encryptByPublicKey(input1.getBytes(),publicKey);
			// String encodedData1Str=enc.encode(encodedData1);
			// System.out.println("密文:"+encodedData1Str);
			// byte[]
			// decodedData1=decryptByPrivateKey(dec.decodeBuffer(encodedData1Str),privateKey);
			//
			...
			// byte[]
			// encodedData2=encryptByPrivateKey(input2.getBytes(),privateKey);
			// String encodedData2Str=enc.encode(encodedData2);
			// System.out.println("密文:"+encodedData2Str);
			// byte[]
			// decodedData2=decryptByPublicKey(dec.decodeBuffer(encodedData2Str),publicKey);
