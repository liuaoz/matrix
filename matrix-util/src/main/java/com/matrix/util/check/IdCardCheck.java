...
public class IdCardCheck {
	 ...
	 * @return
	 */
	public IdCardCheck(String cardNumber) {
		if (null != cardNumber) {
	...
	private static String contertToNewCardNumber(String oldCardNumber) {
		...
		buf.append(IdCardCheck.calculateVerifyCode(buf));
		return buf.toString();
	}

	public static void main(String[] args) {
		String id = "370111640110161";
		IdCardCheck cardcheck = new IdCardCheck(id);
		System.out.println(cardcheck.validate());
	}
}