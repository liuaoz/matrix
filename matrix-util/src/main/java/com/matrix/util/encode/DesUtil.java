...
public class DesUtil {
	...
	/*
	 */
	private static void desMemcpy(byte[] output, byte[] input, int outpos, int inpos, int len) {
		int i;
		for (i = 0; i < len; i++)
	...
	public static String Decode(String str) {
		...
		i2 = DesUtil.DECRYPT(DesUtil.strDefaultKey.getBytes(), byteMingW, byteMiW, byteMiW.length);
